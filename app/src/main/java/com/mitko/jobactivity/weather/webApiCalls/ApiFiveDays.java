 ...
 */
public class ApiFiveDays extends AsyncTask<JSONObject, Void, JSONObject> {
    ...
    public ApiFiveDays(Context context) {
    ...
    protected JSONObject doInBackground(JSONObject... params) {
        ...
        try {
            weatherUrl = "http://api.openweathermap.org/data/2.5/forecast?lat=" + lat + "&lon=" + lon + "&cnt=5" + "&APPID=889ea6ae9738bd030d9aabb9f82520b1";
